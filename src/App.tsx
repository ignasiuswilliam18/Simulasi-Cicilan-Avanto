...
<ResultCard
  ...
  productName={product}
  tenor={tenor}
  monthlyInstallment={simulation.hpOnly.monthlyInstallment}
  productPrice={simulation.hpOnly.totalPrice}
  downPayment={simulation.hpOnly.downPayment}
  financedAmount={simulation.hpOnly.principal}
  admin={simulation.hpOnly.adminFee}
  interest={simulation.hpOnly.interest}
  interestRate={interestRate} 
  onCopy={() => copyResult("HP ONLY", simulation.hpOnly)}
/>
